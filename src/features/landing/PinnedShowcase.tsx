...
const SHOWCASE = [
  {
    ...
    title: '이름 옆에 항상 관심사가',
    desc: '모든 메시지·멤버 목록에 관심사 태그가 붙고, 나와 겹치는 관심사는 ✦로 빛나요. 문구가 달라도 비슷한 관심사면 AI가 알아서 묶어주고요.',
    mock: <MockChat />,
  },
  {
  ...
  },
  {
    ...
    title: '게임 한 판이면 친구',
    desc: '빙고·끝말잇기·오목·틱택토·밸런스게임·초성퀴즈 — 6종을 채팅 옆 패널에서 바로. 120초 도화선 폭탄 돌리기, 실시간 대전, 승리 폭죽까지.',
    mock: <MockGames />,
  },
  {
    icon: <TvIcon size={20} />,
